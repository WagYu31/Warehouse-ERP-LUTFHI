...
export default function UsersPage() {
  ...
  const openAdd = () => { setEditing(null); setForm({ name:'', email:'', password:'', role:'staff' }); setModal(true) }
  const openEdit = (row) => { setEditing(row); setForm({ name: row.name, email: row.email, password:'', role: row.role }); setModal(true) }
